...
public class DataTuple {
	...
	// ########## - Edible Time para Blinky - ###########
	public int blinkyEdibleTime;

	// ########## - Test y pruebas - ####################
	public int nodeBlinky;
	...
	public DataTuple(Game game, MOVE move) {
		...
		// ########### - Blinky Edible Time - ##########
		blinkyEdibleTime = game.getGhostEdibleTime(GHOST.BLINKY);

		// ########## - Test y pruebas - ####################
		nodeBlinky = game.getGhostCurrentNodeIndex(GHOST.BLINKY);
